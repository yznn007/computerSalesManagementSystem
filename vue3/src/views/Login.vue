  ...
  ╚═════╝ ╚══════╝</pre
			...
			<form @submit.prevent="handleLogin">
				<input
					...
					class="field"
					:placeholder="mode === 'customer' ? '手机号' : '用户名'"
				/>
				<input
		...
		>
			...
			>
				<el-form-item label="姓名"
					><el-input v-model="reg.customer_name"
				/></el-form-item>
...
const handleRegister = async () => {
	const r = reg.value;
	if (!r.customer_name || !r.phone || !r.address)
		return ElMessage.warning("请填写完整");
	...
	try {
		...
		reg.value = { customer_name: "", phone: "", address: "", password: "" };
	} catch {
	} finally {
